...
- **Google Earth Engine** (editor de código, JavaScript) para generar la capa
  de nubosidad a partir de MODIS MOD09GA; el script `nubosidad_gee.js` se ejecuta
  en https://code.earthengine.google.com, no en el entorno de ArcGIS.
...
|---|---|---|
| `nubosidad_gee.js` | Preparación de datos | Nubosidad media de Aragón (criterio C5) a partir de MODIS MOD09GA 2016–2025, exportada a 1 km en EPSG:25830. Se ejecuta en el editor de Google Earth Engine, no en arcpy |
